...
This guide covers day-to-day configuration, recovery, and native background-service behavior. The current public pre-release is `v0.1.0-alpha.4`; newer development commits may still require building from source until another release is published.
